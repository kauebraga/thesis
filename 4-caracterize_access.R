...
caracterize_scenario <- function(scenario) {
  ...
  boxplot_income <- ggplot()+
    ...
    labs(x = "",
         y = "Accessibility rel. dif.")+
    guides(colour = guide_legend(nrow = 1))+
    coord_cartesian(ylim = c(-0.5, 0.5))

  # save
  ggsave(plot = boxplot_income, filename = sprintf("figures/paper1/boxplot_income_%s.png", scenario),
  ...
  # save
  ggsave(plot = scatterplot_income, filename = sprintf("figures/paper1/scatterplot_income_%s.png", scenario),
